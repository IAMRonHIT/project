...
import { Search, Filter, Plus, ArrowUpRight, MapPin, Star, Activity, Users, Building2 } from 'lucide-react';
import { ProvidersMetrics } from './components/ProvidersMetrics';
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`p-2 rounded-lg transition-colors ${
              viewMode === 'table'
                ? isDark
                  ? 'bg-[#CCFF00] text-ron-dark-navy'
                  : 'bg-ron-primary text-white'
                : isDark
                  ? 'text-white hover:bg-white/10'
                  : 'text-ron-dark-navy hover:bg-ron-primary/10'
            }`}
          >
