...
export function KanbanColumn({ title, tasks, status, onTaskMove, theme }: KanbanColumnProps) {
  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      <div className={`absolute inset-0 ${theme.columnBg} rounded-xl border ${theme.border} circuit-pattern bg-gradient-to-b from-[#334155] to-[#334155]`} />
      ...
      {/* Tasks Container */}
      <div
        className={`flex-1 p-4 space-y-4 overflow-y-auto relative z-10 rounded-xl transition-all duration-200 ease-in-out`}
