...
import { ViewSwitcher, type ViewType } from '../../components/Kanban/ViewSwitcher';
import { NewTaskDialog } from '../../components/Kanban/NewTaskDialog';
import { ThemeSwitcher } from '../../components/Kanban/ThemeSwitcher';
...
// Themes mapping from the main app theme to kanban themes
const themeMapping = {
  light: {
    background: 'bg-white',
    text: 'text-gray-900',
...
export default function KanbanPage() {
  ...
  const currentTheme = themeMapping[theme as keyof typeof themeMapping];
